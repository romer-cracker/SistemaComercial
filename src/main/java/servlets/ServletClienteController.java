		...
		try {
			...
			if (acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
			    ...
			    String idCliente = request.getParameter("idCliente");
			     ...
			     ModelCliente modelCliente = daoClienteRepository.consultarClienteID(idCliente, super.getUserLogado(request));
				...
				List<ModelCliente> modelClientes = daoClienteRepository.consultarClienteListPaginada(this.getUserLogado(request), offset);
